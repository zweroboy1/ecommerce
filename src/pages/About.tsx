      ...
      <main className="main page about container">
        ...
        <div className="about__as">
          <div>
            ...
            <p>
              Наше сотрудничество также включало в себя обмен знаниями и опытом. Мы всегда готовы
              были помочь друг другу, разделять свои знания и учиться вместе. Эта атмосфера
              взаимопомощи и поддержки была фундаментом нашего успеха.
            </p>
            <p>
              В итоге, благодаря тесному сотрудничеству и выдающемуся вкладу каждого члена команды,
              мы смогли успешно завершить проект и достичь поставленных целей.
            </p>
          </div>
